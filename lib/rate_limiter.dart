...
class RateLimiter {
  ...
  bool passesHeaderRateLimit(int now) {
    ...
    if (twoMinutesAgo > lastCheckedHeaders) return true;
    ...
    if (lowerRatio > 95.0 || upperRatio > 95.0) return false;
    return true;
  }
  ...
  bool passesApiCallsRateLimit(int now) {
    ...
    if (listSinceTwoMinutes.length >= appMaxCallsPerTwoMinutes) return false;
    return true;
  }
}
