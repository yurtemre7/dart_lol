...
class LolStorage {
  final summonerStorage = LocalStorage('summoners');
  final matchHistoryStorage = LocalStorage('match_histories');
  final matchStorage = LocalStorage('matches');

  final rankedChallengerSoloStorage = LocalStorage('ranked_challenger_solo');
  ...
  Map<String, dynamic> getMatch(String matchId) {
    ...
    if (matchString == null) {
      ...
      return json.decode(matchString);
    }
  }
  ...
  List<dynamic> getMatchHistories(String puuid) {
    ...
    if (matchHistoriesString == null) {
      ...
      return json.decode(matchHistoriesString);
    }
  }
